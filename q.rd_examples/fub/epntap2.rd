...
<!--			Flavour of the coordinate system should be the same as for ProcDef-->
                <processEarly>
                        <setup>
                                <code>
				...
				def setMyUnits(mySpatialFrameType):
					if   mySpatialFrameType == "celestial":   c1, c2, c3 = "deg", "deg", "m"
					elif mySpatialFrameType == "body":        c1, c2, c3 = "deg", "deg", "m"	
					elif mySpatialFrameType == "cartesian":   c1, c2, c3 = "m",   "m",   "m"
					elif mySpatialFrameType == "cylindrical": c1, c2, c3 = "m",   "deg", "m"
					elif mySpatialFrameType == "spherical":   c1, c2, c3 = "m",   "deg", "m"
		...
		<events>
			...
			<column name="granule_uid" type="text" required="True"
				ucd="meta.id"
				description="Internal table row index - unique ID in data service.">
<!--also in v2. Can be alphanum-->
				<property key="std">1</property>
			</column>
			<column name="granule_gid" type="text" required="True"
				ucd="meta.id"
				description="Common to granules of same type.">
<!-- (e.g. same map projection, or geometry data products). Can be alphanum.-->
				<property key="std">1</property>
			</column>
			<column name="obs_id" type="text" required="True"
				ucd="meta.id"
				description="Associates granules derived from the same data.">
<!-- (e.g. various representations / processing levels). 
...
-->
			...
			<column name="target_name"	type="text" 
				...
				description="Standard IAU name of target">
<!-- (from a list related to target class), case sensitive-->
				<property key="std">1</property>
			</column>
			...
			<column name="s_region"	type="spoly" 
				...
				description="ObsCore-like footprint">
<!--, assume spatial_coordinate_description –  this one TBC 
(needs another param for GIS interface?)-->
				<property key="std">1</property>
			</column>
			<FEED source="_minmax"
				basename="c1_resol"
...
<!--, with multiple entries separated by space characters-->
				<property key="std">1</property>
			</column>
